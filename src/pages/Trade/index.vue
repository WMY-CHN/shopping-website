  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="order in orderList.detailArrayList"
          :key="order.skuId"
        >
          <li>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      orderList: (state) => state.trade.orderInfo,
    }),
    //底部订单地址显示
    userAdd() {
      //查找符合要求的元素返回
  ...
  methods: {
    ...
    async submitOrder() {
      let data = {
        consignee: this.userAdd.consignee, //收件人
        consigneeTel: this.userAdd.phoneNum, //电话
        deliveryAddress: this.userAdd.fullAddress, //地址

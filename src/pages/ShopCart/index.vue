  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllChecked" @change="updateAllCartChecked" :disabled="!cartInfoList.length"/>
        <span>全选</span>
      </div>
      <div class="option">
...
export default {
  ...
  methods: {
    ...
    //修改产品数量 type区分页面元素 disNum变化量或输入量  cart修改的商品ID
